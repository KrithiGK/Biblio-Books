...
public class CategoryDaoJdbc implements CategoryDao {
    ...
    public List<Category> findAll() {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreUpdateDbException("Encountered a problem finding all categories", e);
        }
        return categories;
    }
    ...
    public Category findByCategoryId(long categoryId) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreUpdateDbException("Encountered a problem finding category " + categoryId, e);
        }
        return category;
    }
    ...
    public Category findByName(String name) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreUpdateDbException("Encountered a problem finding category " + name, e);
        }
        return category;
    }
